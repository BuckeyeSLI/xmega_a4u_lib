...
static XA4U_USART_ERR_t FIFOWrite(volatile FIFOBuffer_t *buffer, uint8_t byte)
{
...
static XA4U_USART_ERR_t FIFORead(volatile FIFOBuffer_t *buffer, uint8_t *byte)
{
	ATOMIC_BLOCK(ATOMIC_RESTORESTATE) // Ensure buffer is accessed atomically
	{
